...
export const useAcervoStore = defineStore('acervo', {
  state: () => ({
    ...
    subtipos: [
      { id: 1, materia_prima_id: 1, termo: "Cerâmica" },
      { id: 2, materia_prima_id: 1, termo: "Rocha Lascada" },
      { id: 3, materia_prima_id: 1, termo: "Rocha Polida" },
      { id: 4, materia_prima_id: 2, termo: "Cestaria" },
      { id: 5, materia_prima_id: 2, termo: "Madeira" },
      { id: 6, materia_prima_id: 3, termo: "Osso" },
      { id: 7, materia_prima_id: 3, termo: "Concha" },
      { id: 8, materia_prima_id: 3, termo: "Fóssil" },
      { id: 9, materia_prima_id: 3, termo: "Adorno" }
    ],
