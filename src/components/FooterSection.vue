...
const contactInfo = reactive({
  email: 'contato@museudosambaqui.br',
  phone: '(47) 3433-0114',
  address: 'R. Dona Francisca, 600 - Centro, Joinville - SC'
})
...
<template>
  <footer class="bg-gradient-to-r from-gray-50 to-gray-100 border-t border-gray-200 fixed w-full">
